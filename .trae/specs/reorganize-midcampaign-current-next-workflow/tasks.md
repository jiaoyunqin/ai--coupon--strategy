...
- [ ] Task 5: 执行静态、浏览器和回归验证。
  - [ ] SubTask 5.1: 运行 JavaScript 语法、重复 ID、`undefined`、敏感信息和 `git diff --check`。
  - [ ] SubTask 5.2: 验证 38节、618、双11及不同年份/波次下的数据、候选、详情和会话上下文。
  - [ ] SubTask 5.3: 验证桌面宽屏、1440px、1280px、1024px、860px 和 760px 布局。
  - [ ] SubTask 5.4: 验证键盘、ARIA、控制台、数据追问、方案追问和继续调整链路。
  - [ ] SubTask 5.5: 回归 03 实时监控、促前默认工作台和既有历史会话。
